                    ...
                    <a href="">
                        <div class="custom--overview-header">
                            ...
                            <div class="custom-icon-left">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.16667 8.83333C3.25 8.83333 2.5 9.58333 2.5 10.5C2.5 11.4167 3.25 12.1667 4.16667 12.1667C5.08333 12.1667 5.83333 11.4167 5.83333 10.5C5.83333 9.58333 5.08333 8.83333 4.16667 8.83333Z" stroke="#121212" stroke-width="1.5" />
                                    <path d="M15.8327 8.83333C14.916 8.83333 14.166 9.58333 14.166 10.5C14.166 11.4167 14.916 12.1667 15.8327 12.1667C16.7493 12.1667 17.4993 11.4167 17.4993 10.5C17.4993 9.58333 16.7493 8.83333 15.8327 8.83333Z" stroke="#121212" stroke-width="1.5" />
                                    <path d="M10.0007 8.83333C9.08398 8.83333 8.33398 9.58333 8.33398 10.5C8.33398 11.4167 9.08398 12.1667 10.0007 12.1667C10.9173 12.1667 11.6673 11.4167 11.6673 10.5C11.6673 9.58333 10.9173 8.83333 10.0007 8.83333Z" stroke="#121212" stroke-width="1.5" />
                                </svg>
    ...
    <div class="custom--container-add-item">
        <div class="custom--add-item" id="add-item">
            <div class="custom--content">
                ...
                <form action="tambahBarang/addBarang" method="post">
            ...
            <div class="custom--content">
                ...
                <form action="editBarang">
                    <div class="custom--input-add-item">
                        ...
                        <div class="custom--input-add-item-wrapper">
                            <label for="">Jumlah Pemeliharaan</label>
                            <input type="text">
