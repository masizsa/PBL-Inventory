...
<script>
    ...
    const selectMenu = () => {
        ...
        // Mencari indeks dari string "public/"
        var publicIndex = fullURL.indexOf("public/");

        if (publicIndex !== -1) {
            // Mengambil bagian setelah "public/"
            var afterPublic = fullURL.substring(publicIndex + 7);

            // Menampilkan hasilnya
            console.log(afterPublic);
        } else {
            console.log("String 'public/' tidak ditemukan dalam URL.");
        }
