    <section class="custom--sidebar ">
        ...
        <div class="body-sidebar">
            <ul class="list-menu">
                <li>
                    <a class="" href="http://localhost/dasarWeb/PBL-Inventory/public/dataBarang">
                        <div class="list-icon">
                ...
                <li>
                    <a class="" href="http://localhost/dasarWeb/PBL-Inventory/public/peminjaman">
                        <div class="list-icon">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="1">
                ...
                <li>
                    <a class="" href="http://localhost/dasarWeb/PBL-Inventory/public/riwayatAdmin">
                        <div class="list-icon">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="1">
                ...
                <li>
                    <a class="" href="http://localhost/dasarWeb/PBL-Inventory/public/ubahSandi">
                        <div class="list-icon">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="1">
