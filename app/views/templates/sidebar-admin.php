    <section class="custom--sidebar ">
        ...
        <div class="body-sidebar">
            <ul class="list-menu">
                <li>
                    <a class="" href="http://localhost/dasarWeb/PBL-Inventory/public/tambahBarang">
                        <div class="list-icon">
                ...
                <li>
                    <a class="" href="http://localhost/dasarWeb/PBL-Inventory/public/riwayat">
                        <div class="list-icon">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="1">
                ...
                <li>
                    <a class="" href="http://localhost/dasarWeb/PBL-Inventory/public/gantiSandi">
                        <div class="list-icon">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="1">
